...
const Footer = () => {
  ...
  return (
    <motion.footer
      ...
      className="bg-white/5 backdrop-blur-lg border-t border-white/10 mt-24"
    >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          {footerLinks.map((section, index) => (
            <motion.div
              ...
              className="space-y-4"
            >
              <h4 className="text-lg font-semibold text-gray-300">{section.title}</h4>
          ...
          >
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400 text-sm">123 Business Street, New Delhi</span>
              </div>
              <div className="flex items-center space-x-3">
                <FaEnvelope className="text-cyan-400" />
                <span className="text-gray-400 text-sm">support@shopease.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <FaPhone className="text-cyan-400" />
                <span className="text-gray-400 text-sm">(987) 654-3210</span>
              </div>
            </div>
          </motion.div>
        </div>
          ...
          <div className="max-w-md mx-auto text-center">
            ...
            <div className="flex gap-4">
              <input
                ...
                className="w-full bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg py-3 px-4 text-gray-300 placeholder-gray-400 focus:outline-none focus:border-cyan-400 transition-all"
              />
              <motion.button
