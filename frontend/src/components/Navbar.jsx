...
const Navbar = () => {
  ...
  return (
    <div className="w-full fixed top-0 left-0 z-50">
      {/* Topbar */}
      {/* <div className="w-full flex justify-between items-center px-4 sm:px-12 py-4 bg-white/5 dark:bg-black/30 backdrop-blur-lg shadow-md border-b border-white/10"> */}
      <div className="w-full h-12 sm:h-20 flex justify-between items-center px-4 sm:px-12 bg-white/5 dark:bg-black/30 backdrop-blur-lg shadow-md border-b border-white/10">
