  ...
  useEffect(() => {
    const fetchShopDetails = async () => {
      try {
        ...
        // Convert shop address to coordinates
        const geoResponse = await axios.get(
          `https://nominatim.openstreetmap.org/search?format=json&q=${encodeURIComponent(
            response.data.shopAddress
          )}`
        );
        ...
        console.error("Error fetching shop details or geolocation:", error);
      }
    };
              ...
              {coordinates ? (
                ...
                >
                  ...
                  <Marker position={[coordinates.lat, coordinates.lng]}>
                    <Popup>{shopDetails.shopName}</Popup>
                  </Marker>
                </MapContainer>
              ) : (
