...
//   return (
//     <section className="relative px-6 md:px-12 py-16 bg-gray-100 overflow-hidden">
//       <motion.h2 
//         initial={{ opacity: 0, y: 20 }}
//         animate={{ opacity: 1, y: 0 }}
//         className="text-4xl font-bold text-center mb-12 text-gray-800"
...
//         className="absolute left-4 top-1/2 z-20 -translate-y-1/2 p-3 rounded-full bg-white/80 backdrop-blur-sm shadow-lg hover:bg-white transition-all disabled:opacity-50"
//       >
...
//         className="absolute right-4 top-1/2 z-20 -translate-y-1/2 p-3 rounded-full bg-white/80 backdrop-blur-sm shadow-lg hover:bg-white transition-all disabled:opacity-50"
//       >
...
//           <div 
//             key={slideIndex}
//             className="w-full shrink-0 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-4"
//           >
//             {categories
...
//                   whileHover={{ scale: 1.05 }}
//                   className={`${category.bg} rounded-2xl p-6 cursor-pointer shadow-lg hover:shadow-xl relative overflow-hidden group`}
//                 >
//                   {/* Animated Background */}
//                   <motion.div
//                     initial={{ scale: 0 }}
...
//               index === currentSlide ? 'bg-gray-800 scale-125' : 'bg-gray-300'
//             }`}
//           />
//         ))}
//       </div>
...
//   return (
//     <div className="mx-7"> {/* Wrapper div matching offer section width */}
//       <section className="relative py-16 bg-gray-100 overflow-hidden rounded-3xl shadow-2xl">
//         <motion.h2 
//           initial={{ opacity: 0, y: 20 }}
//           animate={{ opacity: 1, y: 0 }}
//           className="text-4xl font-bold text-center mb-12 text-gray-800"
...
//         <button
//           onClick={prevSlide}
//           className="absolute left-4 top-1/2 z-20 -translate-y-1/2 p-3 rounded-full bg-white/80 backdrop-blur-sm shadow-lg hover:bg-white transition-all"
//         >
//           <ChevronLeftIcon className="h-8 w-8 text-gray-800" />
//         </button>
...
//         <button
//           onClick={nextSlide}
//           className="absolute right-4 top-1/2 z-20 -translate-y-1/2 p-3 rounded-full bg-white/80 backdrop-blur-sm shadow-lg hover:bg-white transition-all"
//         >
//           <ChevronRightIcon className="h-8 w-8 text-gray-800" />
//         </button>
...
//             <div 
//               key={slideIndex}
//               className="w-full shrink-0 grid grid-cols-2 md:grid-cols-4 gap-6"
//             >
//               {categories
//                 .slice(slideIndex * itemsPerView, (slideIndex + 1) * itemsPerView)
//                 .map((category, index) => (
...
//                       <motion.div
//                         whileHover={{ rotate: 360 }}
//                         className="bg-white/20 p-4 rounded-full h-16 w-16 flex items-center justify-center"
//                       >
...
//   return (
//     <div className="mx-7 my-20 overflow-hidden">
...
//               const zIndex = totalCategories - distance;

//               return (
//                 <motion.div
//                   key={category.name}
//                   className="absolute w-[320px] h-[400px] origin-center transform-preserve-3d"
//                   style={{
